        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionPinHash = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    PinFailureCount = table.Column<int>(type: "int", nullable: false),
                    PinLockedUntil = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyWithdrawalLimit = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TodayWithdrawnAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    PinVerified = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionLedgerEntries_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransactionLedgerEntries_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_NationalIdentityNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionLedgerEntries_AccountId",
                table: "TransactionLedgerEntries",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionLedgerEntries_TransactionId",
                table: "TransactionLedgerEntries",
